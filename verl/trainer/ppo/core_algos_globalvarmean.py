...
def compute_grpo_outcome_advantage(
    ...
    grpo_uid_to_pos_count: Optional[dict] = None,
    grpo_uid_to_neg_count: Optional[dict] = None,
    **kwargs,
    ...
    Note:
        ...
        If grpo_uid_to_pos_count and grpo_uid_to_neg_count are provided, mean and std will be computed
        from the full sampling statistics before downsampling using torch.mean() and torch.std() 
        on the reconstructed sample distribution, providing more accurate baselines.
