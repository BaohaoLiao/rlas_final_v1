...
MODEL_PATH="Qwen/Qwen2.5-Math-1.5B" # 确保这里的模型大小 (7B) 和实验名称一致
...
exp_name='DAPO-Qwen2.5-1.5b-MATH-fix-gen8-continuous' # 更新了实验名称以作区分
...
TRAIN_FILE="${HOME}/data/openr1/train_hard.parquet"
#"${DATA_HOME}/data/dapo-math-17k.parquet"
TEST_FILE="${HOME}/data/test/test.parquet"
...
top_p=1.0
top_k=-1
val_temperature=0.0  # greedy for validation
val_top_p=1.0
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.filter_min_positive_samples=2 \
