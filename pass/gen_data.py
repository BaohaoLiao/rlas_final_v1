...
ds = load_dataset(script_args.dataset_name_or_path, split="train")#.select(range(1000))
...
for i, output in enumerate(outputs):
    tmp_data = {"prompt": ds[i]["prompt"], "gt": ds[i]["answer"], "responses": [out.text for out in output.outputs]}
