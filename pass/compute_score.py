...
ds = load_dataset("json", data_files=script_args.dataset_path, split="train")#.select(range(100))
...
for i in range(len(ds)):
    ...
    sample = ds[i]
    sample.update({"scores": all_scores[i]})
...
with open(script_args.record_path.replace(".txt", ".json"), "w") as f:
